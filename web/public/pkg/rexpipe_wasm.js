/* @ts-self-types="./rexpipe_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function process_pipeline(request_json) {
    const ptr0 = passStringToWasm0(request_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.process_pipeline(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function validate_pattern(pattern, flags_json) {
    const ptr0 = passStringToWasm0(pattern, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(flags_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.validate_pattern(ptr0, len0, ptr1, len1);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rexpipe_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
